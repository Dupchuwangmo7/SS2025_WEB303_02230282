...
- 1 API Gateway (central entry point on port 8080)
...
### Test Individual Microservices Directly
...
curl http://localhost:8082/menu/1

# Order service directly
curl http://localhost:8083/orders
```

### Test Monolith Standalone (Reference Implementation)

To test the monolith in isolation, run its docker-compose:
...
- Phase 1: Monolithic application (complete - reference/standalone)
- Phase 2: Extract menu-service (complete)
- Phase 3: Extract user-service (complete)
- Phase 4: Extract order-service (complete - with inter-service communication)
- Phase 5: Add API Gateway (complete)

**Current Implementation Status:**

- Docker Compose orchestrates 3 microservices with 3 databases
- API Gateway routes all traffic on port 8080
- Services communicate via HTTP with container hostname resolution
- Complete database-per-service pattern implemented

**Future enhancements (Phase 6+):**

- Add Consul for dynamic service discovery
- Replace hardcoded service URLs with Consul lookups
- Add distributed health checks to services
...
- Practical report: `PRACTICAL5_REPORT.md`
- Reference implementation: This directory
- Related practicals:
