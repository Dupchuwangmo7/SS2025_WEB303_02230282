...
// MenuServer implements the gRPC MenuService interface for menu operations
type MenuServer struct {
	menuv1.UnimplementedMenuServiceServer
}

// NewMenuServer initializes a new gRPC menu service server
func NewMenuServer() *MenuServer {
	return &MenuServer{}
}

// GetMenuItem retrieves a specific menu item by its unique identifier
